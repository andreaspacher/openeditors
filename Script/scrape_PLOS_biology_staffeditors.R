...
EdB <- do.call(rbind, Map(data.frame, editor = peoples, affiliation = NA, orcid=orcid, role = roles))
...
write.csv(EdB, paste0("Output\\2022-Scraping\\plos-biology-staff-editors-", Sys.Date(), ".csv"))
